...
global $sparkling_footer_info;
  printf( esc_html__( 'Theme by %1$s Powered by %2$s', 'sparkling' ) , '<a href="http://leadtech.com/" target="_blank">Leadtech</a>', '<a href="http://wordpress.org/" target="_blank">WordPress</a>');
}
